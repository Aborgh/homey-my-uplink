import FSeriesParameterIds from "../models/parameter-enum.mjs";
...
export class SettingsManager {
    ...
    async updateHeatpumpSettings() {
        ...
        if (this.hasOperationalMode) {
            parameters.push(FSeriesParameterIds.OPERATION_MODE);
        }
        ...
        try {
            ...
            if (this.hasOperationalMode) {
                const opMode = parameterValues.find(
                    param => param.parameterId === FSeriesParameterIds.OPERATION_MODE ||
            ...
            for (const key of changedKeys) {
                switch (key) {
                    case "operational_mode":
                        if (this.hasOperationalMode) {
                            updates[FSeriesParameterIds.OPERATION_MODE] = Number(newSettings.operational_mode);
                        }
                        break;
